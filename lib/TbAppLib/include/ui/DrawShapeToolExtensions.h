...
class DrawShapeToolCorridorExtension : public DrawShapeToolExtension
{
public:
  explicit DrawShapeToolCorridorExtension(MapDocument& document);
...
class DrawShapeToolChamberExtension : public DrawShapeToolExtension
{
public:
  explicit DrawShapeToolChamberExtension(MapDocument& document);
